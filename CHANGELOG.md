...
## [3.6.0](https://www.github.com/mikejohanson/nvidia-snatcher/compare/v3.5.0...v3.6.0) (2021-04-23)


### Features

* add interactive captcha handler with Slack and Discord ([#2385](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2385)) ([409769e](https://www.github.com/mikejohanson/nvidia-snatcher/commit/409769e6dbd3add614fcd985731bb244297a2c2d))
* change max price behavior ([9b02c36](https://www.github.com/mikejohanson/nvidia-snatcher/commit/9b02c36370aaf7fef20a90b2427273c2f7b30f00))
* color empty stores ([#2312](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2312)) ([bbfa808](https://www.github.com/mikejohanson/nvidia-snatcher/commit/bbfa808b820ee2d16c65dfdcecce58645f4899d0))
* **notification:** add support for Free mobile ([#2285](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2285)) ([6be2e0d](https://www.github.com/mikejohanson/nvidia-snatcher/commit/6be2e0d491646d6e88f72f67c694874b11cda03a))
* **notifications:** add apple push notifications ([#2077](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2077)) ([6b78b2e](https://www.github.com/mikejohanson/nvidia-snatcher/commit/6b78b2ee4445ad2b868b6f848730a474ca12d657))
* **pushover:** ability to specify device ([#2101](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2101)) ([d03aea0](https://www.github.com/mikejohanson/nvidia-snatcher/commit/d03aea05a7783c9cc6a18c8baf0381050c105357))
* **pushover:** add support for sound ([#2203](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2203)) ([83ce922](https://www.github.com/mikejohanson/nvidia-snatcher/commit/83ce922761f85a13424ed43a1961668ffc870485))
* **series:** support for rx6700xt ([#2290](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2290)) ([113c9ce](https://www.github.com/mikejohanson/nvidia-snatcher/commit/113c9ce19f3ed1f140eec7cd555ec373f25d256f))
* **store:** add amd-be store ([#2338](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2338)) ([6e9b1a9](https://www.github.com/mikejohanson/nvidia-snatcher/commit/6e9b1a9640ca93f620623d53624230514fac6d40))
* **store:** add amd-nl store ([#2072](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2072)) ([49c9e8c](https://www.github.com/mikejohanson/nvidia-snatcher/commit/49c9e8c0dc5c3b25ce2aa20265ccd2865f229385))
* **store:** Add AO and BT (UK) ([#2089](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2089)) ([1714e89](https://www.github.com/mikejohanson/nvidia-snatcher/commit/1714e89af7964d06b01120fb75595ef8ec8177ba))
* **store:** add materiel.net (french), 35 3060ti references ([#2287](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2287)) ([0ebe745](https://www.github.com/mikejohanson/nvidia-snatcher/commit/0ebe7451e4e4c6e46c64e3782bd51a92ce594dca))
* **store:** add mediamarkt austria ([#1836](https://www.github.com/mikejohanson/nvidia-snatcher/issues/1836)) ([ae8e72a](https://www.github.com/mikejohanson/nvidia-snatcher/commit/ae8e72a73044b8311add15d2b5c10936bae16e82))
* **store:** add MightyApe, NoelLeeming and TheWarehouse (NZ) ([#2133](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2133)) ([e2d8040](https://www.github.com/mikejohanson/nvidia-snatcher/commit/e2d804027a3ec6a19201ef9ce35dcb4c4dee7025))


### Bug Fixes

* add missing tests in Dockerfile ([#2323](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2323)) ([cd6e1f6](https://www.github.com/mikejohanson/nvidia-snatcher/commit/cd6e1f614bcaf00bc468c32a1b5a98cb51c7730f))
* **amazon-es:** use euroFormat ([#2371](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2371)) ([4eb702b](https://www.github.com/mikejohanson/nvidia-snatcher/commit/4eb702b9a1187c8dcf159ea991ab1049c3c44bb2))
* **apns:** use when specified ([99a274d](https://www.github.com/mikejohanson/nvidia-snatcher/commit/99a274dbea088a6bcb053b1c1bf7812d0796442a))
* **discord:** properly wait for webhooks ([#2352](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2352)) ([bc59da1](https://www.github.com/mikejohanson/nvidia-snatcher/commit/bc59da11d512f6f55449781cb8f7f4bd1d3e7e57))
* **docker:** disable opening browser ([d13f7f1](https://www.github.com/mikejohanson/nvidia-snatcher/commit/d13f7f1ff91ada223e8ce7eb50d9a80030cbe668))
* parsing prices with thousands separator and European format ([#2153](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2153)) ([61f8e3a](https://www.github.com/mikejohanson/nvidia-snatcher/commit/61f8e3a9a03136682035881fce6d14356717d1ac))
* **playstation:** fix inStock selector ([#2187](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2187)) ([b0efc83](https://www.github.com/mikejohanson/nvidia-snatcher/commit/b0efc837bc554f5c8635e125b67775d8b1f8f6b3))
* **web:** add favicon to prevent missing icon console error ([#2375](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2375)) ([2be33ac](https://www.github.com/mikejohanson/nvidia-snatcher/commit/2be33ac6147f8f7460d108f361d954b17a335bd9))


### Reverts

* parsing prices with thousands separator and European format ([#2153](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2153)) ([91c4f12](https://www.github.com/mikejohanson/nvidia-snatcher/commit/91c4f12308905f4e6d65341ba54ae814c8ad94d6))
* replace euroFormat with regex ([#2131](https://www.github.com/mikejohanson/nvidia-snatcher/issues/2131)) ([0ff8158](https://www.github.com/mikejohanson/nvidia-snatcher/commit/0ff8158511f4f90dc26407fffa22ab0a4ad3aa0b))
